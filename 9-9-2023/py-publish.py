...
MSG_COUNT = 5
TOPIC_PREFIX = "computers/laptop/linux"
...
broker_props = {
    "solace.messaging.transport.host": os.environ.get('SOLACE_HOST') or "tcps://mr-connection-neuaapbqh0e.messaging.solace.cloud:55443",
    "solace.messaging.service.vpn-name": os.environ.get('SOLACE_VPN') or "senario_test",
    "solace.messaging.authentication.scheme.basic.username": os.environ.get('SOLACE_USERNAME') or "solace-cloud-client",
    "solace.messaging.authentication.scheme.basic.password": os.environ.get('SOLACE_PASSWORD') or "sh6e2u9ht6j958k3oh2p00nqpm",
...
message_body = "this is the body of the msg - Ajai "
